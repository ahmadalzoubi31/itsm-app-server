...
export class AddSettingsTable1751190445567 implements MigrationInterface {
    name = 'AddSettingsTable1751190445567'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "settings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "key" character varying NOT NULL, "value" character varying NOT NULL, "type" "public"."settings_type_enum" NOT NULL, "isActive" boolean NOT NULL, "createdById" uuid, "updatedById" uuid, CONSTRAINT "UQ_0e1d1732465eafe739564acacc9" UNIQUE ("value"), CONSTRAINT "PK_0669fe20e252eb692bf4d344975" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "settings" ADD CONSTRAINT "FK_bca2aae959dca204aead9478ae8" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "settings" ADD CONSTRAINT "FK_62c8a0cd9556d885a5825fd7308" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "settings" DROP CONSTRAINT "FK_62c8a0cd9556d885a5825fd7308"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP CONSTRAINT "FK_bca2aae959dca204aead9478ae8"`);
